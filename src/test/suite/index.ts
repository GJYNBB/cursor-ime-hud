...
export function run(): Promise<void> {
  ...
  mocha.addFile(path.resolve(testsRoot, "./hudState.test.js"));
  ...
  mocha.addFile(path.resolve(testsRoot, "./nativeHelperLifecycle.test.js"));
  ...
  mocha.addFile(path.resolve(testsRoot, "./statusBarPresenter.test.js"));
